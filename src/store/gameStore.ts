...
const LANDMARK_STAGES: StageData[] = [
  ...
  },
  {
    ...
    question: '富士山までの距離は？',
    targetPosition: { x: 0.5, y: 0.2 },
    correctDistance: 18700,
    hint: '富士山の高さは3,776m。河口湖・もみじ回廊から撮影',
    collectionName: '富士山（もみじ回廊）',
    difficulty: 'hard',
    landmark: '富士山',
    category: 'landmark',
  },
  ...
  },
  {
    ...
    correctDistance: 100500,
    hint: '富士山の高さは3,776m。文京シビックセンターから撮影',
    collectionName: '富士山（文京区）',
    difficulty: 'expert',
    landmark: '富士山',
    category: 'landmark',
  },
  ...
  {
    id: 'fuji-kasai',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Ferris_wheel_at_Kasai_Rinkai_Park.jpg/1280px-Ferris_wheel_at_Kasai_Rinkai_Park.jpg',
    question: '富士山までの距離は？',
    targetPosition: { x: 0.5, y: 0.4 },
    correctDistance: 107000,
    hint: '富士山の高さは3,776m。葛西臨海公園から撮影',
    collectionName: '富士山（葛西臨海公園）',
    difficulty: 'expert',
    landmark: '富士山',
    category: 'landmark',
  },
